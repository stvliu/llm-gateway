...
public class ProviderController {
    ...
    public ProviderResponse create(@Valid @RequestBody ProviderCreateRequest request) {
        return ProviderResponse.from(providerService.create(request.toEntity(), request.toModels()));
    }
    ...
    public ProviderResponse update(@PathVariable Long id,
        ...
        return ProviderResponse.from(providerService.update(id, request.toEntity()));
    }
    ...
    public ConnectivityTestResult testConnectivity(
        ...
        return providerService.testConnectivity(request.protocolName(), request.baseUrl(), request.apiKey(), request.model());
    }
}
