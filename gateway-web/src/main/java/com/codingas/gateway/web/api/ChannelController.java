...
public class ChannelController {
    ...
    public void setState(
        ...
        channelService.setState(id, request.getTargetState(), request.getReason());
    }
    ...
    public ChannelEndpointResponse addEndpoint(
        ...
        return ChannelEndpointResponse.from(channelService.addEndpoint(request.toEntity()));
    }
    ...
    public ChannelEndpointResponse updateEndpoint(
            ...
            @PathVariable Long endpointId,
            @Valid @RequestBody ChannelEndpointRequest request) {
        return ChannelEndpointResponse.from(channelService.updateEndpoint(channelId, endpointId, request.toEntity()));
    }
