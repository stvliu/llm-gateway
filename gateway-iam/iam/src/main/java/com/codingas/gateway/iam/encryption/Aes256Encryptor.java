...
import com.codingas.gateway.iam.encryption.Encryptor;
...
public class Aes256Encryptor implements Encryptor {
    ...
    public Aes256Encryptor(Environment environment) {
    ...
    public void init() {
        ...
        if (keySource == null) {
            ...
            try {
                ...
                log.info("Aes256Encryptor initialized with AES-256-GCM");
