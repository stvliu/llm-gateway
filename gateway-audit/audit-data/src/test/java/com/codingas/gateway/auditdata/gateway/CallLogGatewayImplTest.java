...
import com.codingas.gateway.auditdata.dataobject.CallLogDo;
import com.codingas.gateway.auditdata.repository.CallLogRepository;
...
/**
 * CallLogGatewayImpl 单元测试
 *
 * <p>mock CallLogRepository，覆盖 save/findByTraceId/findByUserId 及实体↔数据对象双向转换全字段断言。</p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("CallLogGatewayImpl 测试")
class CallLogGatewayImplTest {

    @Mock
    private CallLogRepository repository;

    @InjectMocks
    private CallLogGatewayImpl gateway;
