...
import com.codingas.gateway.resiliencedata.dataobject.FailoverEventDo;
import com.codingas.gateway.resiliencedata.repository.FailoverEventRepository;
...
@DisplayName("FailoverEventGatewayImpl 测试")
class FailoverEventGatewayImplTest {

    @Mock
    private FailoverEventRepository repository;

    @InjectMocks
    private FailoverEventGatewayImpl gateway;
