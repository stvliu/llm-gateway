package com.codingas.gateway.core.security.authentication;
...
import com.codingas.gateway.core.security.encryption.ApiKeyEncryptionService;
...
public class AuthenticationService {
     ...
     */
    @Cacheable(value = CACHE_NAME, key = "'auth:' + T(com.codingas.gateway.core.security.encryption.ApiKeyEncryptionService).hashKey(#apiKey)", unless = "#result == null")
