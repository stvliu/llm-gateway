...
public class SupplyRoutingService {
    ...
    private static final Logger log = LoggerFactory.getLogger(SupplyRoutingService.class);
    ...
    private final com.codingas.gateway.domain.supply.service.ChannelDomainService channelDomainService;

    public SupplyRoutingService(UserApiKeyGateway userApiKeyGateway,
                                ChannelGateway channelGateway,
                                ChannelCredentialGateway channelCredentialGateway,
                                ProviderGateway providerGateway,
                                UserApiKeyDomainService userApiKeyDomainService,
                                com.codingas.gateway.domain.supply.service.ChannelDomainService channelDomainService) {
