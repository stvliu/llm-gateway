...
import com.codingas.gateway.iamdata.repository.ApplicationRepository;
...
@DisplayName("ApplicationGatewayImpl 测试")
class ApplicationGatewayImplTest {

    @Mock
    private ApplicationRepository repository;

    @InjectMocks
    private ApplicationGatewayImpl gateway;
