...
/**
 * JpaPlanModelCatalogRepository 单元测试：mock Repository 验证委托与 model↔DO 双向转换
 *
 * <p>覆盖 JpaPlanModelCatalogRepository 全部 public 方法（save/findByPlanCodeAndModelName/
 * findByModelName/findAll）。</p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("JpaPlanModelCatalogRepository 单元测试")
class PlanModelCatalogGatewayImplTest {

    @Mock
    private PlanModelCatalogJpaRepository repository;

    @InjectMocks
    private JpaPlanModelCatalogRepository gateway;
