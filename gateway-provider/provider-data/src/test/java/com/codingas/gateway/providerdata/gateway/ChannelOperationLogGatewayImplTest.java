...
import com.codingas.gateway.providerdata.dataobject.ChannelOperationLogJpaEntity;
import com.codingas.gateway.providerdata.repository.ChannelOperationLogJpaRepository;
...
/**
 * ChannelOperationLogGatewayImpl 单元测试：mock Repository 验证委托与 domain↔JPA 实体双向转换
 *
 * <p>覆盖 ChannelOperationLogGatewayImpl 全部 public 方法（save/saveAll/findById/
 * findByChannelId/findByChannelIdAndActions/countByChannelId/findByOperatorId/findByBatchId）。</p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("ChannelOperationLogGatewayImpl 单元测试")
class ChannelOperationLogGatewayImplTest {
    ...
    @InjectMocks
    private ChannelOperationLogGatewayImpl gateway;
