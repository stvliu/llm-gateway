...
/**
 * JpaChannelRepository 单元测试：mock Repository 验证委托与 model↔DO 双向转换
 *
 * <p>覆盖 JpaChannelRepository 全部 public 方法（save/findById/findByProviderId/findAllActive/
...
@DisplayName("JpaChannelRepository 单元测试")
