 ...
 */
package com.codingas.gateway.providerdata.vendor;
...
/**
 * JpaProviderRepository 单元测试：mock Repository 验证委托与 model↔DO 双向转换
 *
 * <p>覆盖 JpaProviderRepository 全部 public 方法（save/findById/findByCode/
 * findAll/count/delete/findByKeyword）。</p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("JpaProviderRepository 单元测试")
