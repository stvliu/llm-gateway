...
/**
 * JpaPlanCatalogRepository 单元测试：mock Repository 验证委托与 model↔DO 双向转换
 *
 * <p>覆盖 JpaPlanCatalogRepository 全部 public 方法（save/findByPlanCode/
 * findByProviderCode/findAll）。</p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("JpaPlanCatalogRepository 单元测试")
class PlanCatalogGatewayImplTest {

    @Mock
    private PlanCatalogJpaRepository repository;

    @InjectMocks
    private JpaPlanCatalogRepository gateway;
