...
import com.codingas.gateway.providerdata.dataobject.ChannelCredentialDo;
import com.codingas.gateway.providerdata.repository.ChannelCredentialRepository;
...
/**
 * ChannelCredentialGatewayImpl 单元测试：mock Repository + CredentialEncryptor 验证
 * 委托与凭证加解密逻辑
 *
...
class ChannelCredentialGatewayImplTest {
    ...
    @InjectMocks
    private ChannelCredentialGatewayImpl gateway;
