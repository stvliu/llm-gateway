...
- Task: Task 6 - 首页
- 映射 OpenSpec task: 6.1 / 6.2 / 6.3
- 阶段: implementing
- 交接文件: openspec/changes/official-website/.comet/handoff/task-6-implementer.md
- 实现提交: 待定
- 风险信号自报: 待定
- 风险任务级 review: 未触发
- 审查-修复轮次: 0（standard 最多 1 轮）
- Comet 约束: 首页 8 区块结构（Hero/信任/四差异化/能力叙事/三产品/生态/控制台轮播/功能网格/CTA）；中英双语（src/data/i18n/home.ts + src/pages/index.astro + src/pages/en/index.astro）；数据化文案；复用 Task 5 BaseLayout
