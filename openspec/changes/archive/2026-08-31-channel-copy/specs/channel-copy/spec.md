...
Provide one-click channel duplication: clone an existing channel's configuration (channel fields, endpoints, model instances, and optionally credentials) into a new channel under the same provider.
