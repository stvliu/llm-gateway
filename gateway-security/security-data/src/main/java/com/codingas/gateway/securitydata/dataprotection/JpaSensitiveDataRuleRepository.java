 ...
 * 敏感数据规则网关 JPA 实现
 *
 * <p>实现 SensitiveDataRuleRepository 接口，使用 JPA 进行持久化。</p>
 */
@Slf4j
@Repository
@RequiredArgsConstructor
public class JpaSensitiveDataRuleRepository implements SensitiveDataRuleRepository {

    private final SensitiveDataRuleJpaRepository repository;
