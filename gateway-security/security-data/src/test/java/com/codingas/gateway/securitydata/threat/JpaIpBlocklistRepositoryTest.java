...
import com.codingas.gateway.securitydata.threat.JpaIpBlocklistRepository;
import com.codingas.gateway.securitydata.threat.IpBlocklistConverter;
...
/**
 * JpaIpBlocklistRepository 单元测试
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("JpaIpBlocklistRepository 测试")
class JpaIpBlocklistRepositoryTest {

    @Mock
    private IpBlocklistJpaRepository repository;

    @Mock
    private IpBlocklistConverter converter;

    @InjectMocks
    private JpaIpBlocklistRepository gateway;
