...
import com.codingas.gateway.securitydata.dataprotection.JpaSensitiveDataRuleRepository;
import com.codingas.gateway.securitydata.dataprotection.SensitiveDataRuleConverter;
import com.codingas.gateway.securitydata.dataprotection.SensitiveDataRuleJpaRepository;
...
/**
 * JpaSensitiveDataRuleRepository 单元测试
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("JpaSensitiveDataRuleRepository 测试")
class JpaSensitiveDataRuleRepositoryTest {

    @Mock
    private SensitiveDataRuleJpaRepository repository;

    @Mock
    private SensitiveDataRuleConverter converter;

    @InjectMocks
    private JpaSensitiveDataRuleRepository gateway;
