 ...
 */
@Service
public class ChatDispatchManagerImpl implements ChatDispatchManager {

    private static final Logger log = LoggerFactory.getLogger(ChatDispatchManagerImpl.class);
