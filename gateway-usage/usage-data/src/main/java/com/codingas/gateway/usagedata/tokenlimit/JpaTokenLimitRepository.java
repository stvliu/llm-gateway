 ...
 * Token 限额网关实现
 *
 * <p>实现 TokenLimitRepository 接口，负责 DO ↔ Entity 转换。</p>
 */
@Slf4j
@Component
@RequiredArgsConstructor
public class JpaTokenLimitRepository implements TokenLimitRepository {

    private final TokenLimitJpaRepository tokenLimitRepository;
