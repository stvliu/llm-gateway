...
public interface ModelRouter {
     ...
     */
    LLMProviderAdapter select(LLMRequest request, RouteGroup.RoutingStrategy strategy);
     ...
     * @throws java.util.NoSuchElementException 如果没有可用的 Provider
     */
    LLMProviderAdapter select(String modelCode, RouteGroup.RoutingStrategy strategy);
}
