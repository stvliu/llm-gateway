...
| **用户体系** | User（单租户） | User + UserRole + Role (RBAC) |
...
| 域 | 实体数 | 实体列表 |
|---|--------|----------|
| ① 身份与访问控制 | 4 | User、Role、Permission、UserRole |
...
| 关系 | 类型 | 说明 |
|------|------|------|
| User (1) : UserRole (N) | 一对多 | 用户拥有多个角色绑定 |
| Role (1) : UserRole (N) | 一对多 | 角色被多个用户使用 |
...
│       ▼                           ▼                           │              │
│  ┌──────────┐                ┌──────────┐ 1:N  ┌──────────┐  │              │
│  │GatewayApi│                │UserRole  │──────│Permission│──┘              │
│  │Key       │                └──────────┘      │   权限   │                 │
│  │网关访问凭证│                                        └──────────┘                 │
│  └──────────┘                                                                  │
│       │                                                                       │
...
| v5.0 | 2026-04-23 | 单租户架构重构：移除 Team/Channel/ChannelKey，Member 改名为 UserRole，新增 RouteGroup/RouteGroupProvider/GatewayApiKey |
