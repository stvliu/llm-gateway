...
> 技术栈详情参见 [技术架构](/architecture/technical/)
...
> **详细接口规范**: 端点定义、请求/响应格式、协议转换规则、错误格式等参见 [API 接口规范](/api/api-spec/)。
...
> 完整错误码定义（网关 API + 管理 API）参见 [API 接口规范](/api/api-spec/) 第五章。
...
**详细检查标准与延迟要求**：> 参见 [应用架构](/architecture/application/#安全设计)
...
> 威胁模型 (STRIDE)、ABAC 属性定义、详细安全检查标准：> 参见 [应用架构](/architecture/application/#安全设计)
...
> 详细技术架构、Feature Flag、数据库策略、API 版本策略：> 参见 [技术架构](/architecture/technical/)
